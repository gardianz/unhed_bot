...
from models import Market, RangeMetrics
...
class MarketFeed:
    ...
    def _build_range_metrics(
        ...
        # 21-minute analysis window before market close:
        # -21 to -16, -16 to -11, -11 to -6, -6 to -3
        segments = [(21, 16), (16, 11), (11, 6), (6, 3)]
        segment_moves: list[float] = []

        for start_min, stop_min in segments:
            ...
            if direction > 0:
                ...
                signed_range = 0.0
            segment_moves.append(signed_range)
